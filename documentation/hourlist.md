...
| 5.5. | 8,5 | Creating better notification and error handling. More general scent graph route, test for helper. Form to choose graph from category or Brand, graph still category only. |
| all | 121,5 | |
